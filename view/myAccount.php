...
<nav>
	<ul class="cd-primary-nav">
		...
		<div class="profile">
			<li class="cd-label"><a href="#"><img class="imgs profilePicture" src="view/images/profile.png"><figcaption><?php echo (new User($_SESSION["userId"]))->getFirstname() . " " . (new User($_SESSION["userId"]))->getLastname(); ?></figcaption></a></li>
